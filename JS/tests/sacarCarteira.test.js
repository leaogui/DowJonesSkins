/* jshint esversion:8 */
const sacarCarteira = require('../Connections/Database/sacarCarteira');
...
test('função deve retirar uma quantia informada da carteira do usuario informado', done => {
    getSaldo.getSaldo('teste1', client).then((preResult)=>{
        sacarCarteira.sacarCarteira(15,'teste1', client).then(()=>{
